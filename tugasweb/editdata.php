    ...
    <fieldset>
        ...
        <table>
            ...
            <tr>
                <td>Nama</td>
                <td>:</td>
                <td><input name="nama" type="text" id="nama" size="50" readonly placeholder="Masukkan Nama"
                value="<?=$data['nama']?>"/></td>
            </tr>
            <!-- checkbox -->
            <tr>
            ...
            <tr>
                ...
                <td>:</td>
                <td><input  type="file" name="foto" id="foto" value="<?=$data['bukti']?>"/></td>
                <td><p><small>Gambar sblmnya</small></p></td>
                <td><img src="img/<?=$data['bukti']?>" width="60px" height="70px"></td>
            </tr>
            <tr>
